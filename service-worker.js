const CACHE='caetano-casa-carnes-v1.0.0';
const ASSETS=['./','./index.html','./app.html','./jarvis.html','./equipe.html','./superadmin.html','./cliente.html','./clienteOficial.html','./styles.css','./js/caetano-core.js','./manifest.json','./assets/icon.svg'];
